...
Open a terminal in VSCode, and navigate to where you would like to make a course folder for your coursework this semester. Then, run the following command in the integrated terminal
```
git clone https://www.github.com/mattrussell2/course-docker cs-COURSENUM # choose anything to replace cs-COURSENUM [e.g. cs-40]
````

This will clone the repository (download all of the files required to build the container), and put everything into a folder named `cs-COURSENUM`. In your terminal, run
```
cd cs-COURSENUM
...
## pull-code
NOTE! This only will work for cs-15. Please use `scp` for other courses. 
